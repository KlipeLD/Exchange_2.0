...
namespace Main {
    ...
    public partial class ExchangeDataSet : global::System.Data.DataSet {
        ...
        public partial class КлиентDataTable : global::System.Data.TypedTableBase<КлиентRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public КлиентRow FindByФамилия(string Фамилия) {
        ...
        public partial class Список_операцийDataTable : global::System.Data.TypedTableBase<Список_операцийRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public Список_операцийRow FindByДата(System.DateTime Дата) {
            ...
            public string Номер_паспорта {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Номер паспорта\' in table \'Клиент\' is DBNull.", e);
                    }
                }
                set {
        ...
        public partial class Список_операцийRow : global::System.Data.DataRow {
            ...
            public int Код {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Код\' in table \'Список операций\' is DBNull.", e);
                    }
                }
                set {
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsКодNull() {
                return this.IsNull(this.tableСписок_операций.КодColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetКодNull() {
                this[this.tableСписок_операций.КодColumn] = global::System.Convert.DBNull;
            }
...
namespace Main.ExchangeDataSetTableAdapters {
    ...
    public partial class КассирTableAdapter : global::System.ComponentModel.Component {
        ...
        public virtual int Fill(ExchangeDataSet.КассирDataTable dataTable) {
        ...
        public virtual ExchangeDataSet.КассирDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ExchangeDataSet.КассирDataTable dataTable = new ExchangeDataSet.КассирDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ExchangeDataSet.КассирDataTable dataTable) {
    ...
    public partial class КлиентTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Клиент` WHERE (((? = 1 AND `Код` IS NULL) OR (`Код` = ?)) AND (`Фамилия` = ?) AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? = 1 AND `Отчество` IS NULL) OR (`Отчество` = ?)) AND ((? = 1 AND `Сумма покупки` IS NULL) OR (`Сумма покупки` = ?)) AND ((? = 1 AND `Сумма продажи` IS NULL) OR (`Сумма продажи` = ?)) AND ((? = 1 AND `Номер паспорта` IS NULL) OR (`Номер паспорта` = ?)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("IsNull_Код", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Код", global::System.Data.DataRowVersion.Original, true, null));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_Код", global::System.Data.OleDb.OleDbType.Integer, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Код", global::System.Data.DataRowVersion.Original, false, null));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Original_Фамилия", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Фамилия", global::System.Data.DataRowVersion.Original, false, null));
            ...
            this._adapter.UpdateCommand = new global::System.Data.OleDb.OleDbCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Клиент` SET `Фамилия` = ?, `Имя` = ?, `Отчество` = ?, `Сумма покупки` = ?, `Сумма продажи` = ?, `Номер паспорта` = ? WHERE (((? = 1 AND `Код` IS NULL) OR (`Код` = ?)) AND (`Фамилия` = ?) AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? = 1 AND `Отчество` IS NULL) OR (`Отчество` = ?)) AND ((? = 1 AND `Сумма покупки` IS NULL) OR (`Сумма покупки` = ?)) AND ((? = 1 AND `Сумма продажи` IS NULL) OR (`Сумма продажи` = ?)) AND ((? = 1 AND `Номер паспорта` IS NULL) OR (`Номер паспорта` = ?)))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Фамилия", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Фамилия", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Имя", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Имя", global::System.Data.DataRowVersion.Current, false, null));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Отчество", global::System.Data.OleDb.OleDbType.VarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Отчество", global::System.Data.DataRowVersion.Current, false, null));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(ExchangeDataSet.КлиентDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual ExchangeDataSet.КлиентDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ExchangeDataSet.КлиентDataTable dataTable = new ExchangeDataSet.КлиентDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ExchangeDataSet.КлиентDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        public virtual int Delete(int Original_Код, string Original_Фамилия, string Original_Имя, string Original_Отчество, global::System.Nullable<int> Original_Сумма_покупки, global::System.Nullable<int> Original_Сумма_продажи, string Original_Номер_паспорта) {
            ...
            if ((Original_Сумма_покупки.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((int)(Original_Сумма_покупки.Value));
            }
            else {
            ...
            if ((Original_Сумма_продажи.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((int)(Original_Сумма_продажи.Value));
            }
            else {
        ...
        public virtual int Update(string Фамилия, string Имя, string Отчество, global::System.Nullable<int> Сумма_покупки, global::System.Nullable<int> Сумма_продажи, string Номер_паспорта, int Original_Код, string Original_Фамилия, string Original_Имя, string Original_Отчество, global::System.Nullable<int> Original_Сумма_покупки, global::System.Nullable<int> Original_Сумма_продажи, string Original_Номер_паспорта) {
            ...
            if ((Original_Сумма_покупки.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[14].Value = ((int)(Original_Сумма_покупки.Value));
            }
            else {
            ...
            if ((Original_Сумма_продажи.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((int)(Original_Сумма_продажи.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Имя, string Отчество, global::System.Nullable<int> Сумма_покупки, global::System.Nullable<int> Сумма_продажи, string Номер_паспорта, int Original_Код, string Original_Фамилия, string Original_Имя, string Original_Отчество, global::System.Nullable<int> Original_Сумма_покупки, global::System.Nullable<int> Original_Сумма_продажи, string Original_Номер_паспорта) {
            return this.Update(Original_Фамилия, Имя, Отчество, Сумма_покупки, Сумма_продажи, Номер_паспорта, Original_Код, Original_Фамилия, Original_Имя, Original_Отчество, Original_Сумма_покупки, Original_Сумма_продажи, Original_Номер_паспорта);
        }
    }
    ...
    public partial class КурсTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(ExchangeDataSet.КурсDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual ExchangeDataSet.КурсDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ExchangeDataSet.КурсDataTable dataTable = new ExchangeDataSet.КурсDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ExchangeDataSet.КурсDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
    ...
    public partial class Список_операцийTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(ExchangeDataSet.Список_операцийDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual ExchangeDataSet.Список_операцийDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ExchangeDataSet.Список_операцийDataTable dataTable = new ExchangeDataSet.Список_операцийDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        public virtual int FillBy(ExchangeDataSet.Список_операцийDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy1(ExchangeDataSet.Список_операцийDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ExchangeDataSet.Список_операцийDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
